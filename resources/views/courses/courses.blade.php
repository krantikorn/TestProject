            ...
            <table class="table-auto w-full">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="px-4 py-2">
                            <a wire:click.prevent="sortBy('price_to_student')" role="button" href="#">
                                Price To Student
                            </a>
                        </th>
                        <th class="px-4 py-2">
                ...
                <tbody>
                    @foreach($courses as $key => $course)
                        <tr>
                            <td class="border px-4 py-2">{{$key + $courses->firstItem() }}</td>
                            ...
                            <td class="border px-4 py-2">{{ $course->first_name.' '.$course->last_name }}</td>
                            ...
                            <td class="border px-4 py-2">
                                <button wire:click="view({{ $course->id }})"
                                    class="bg-blue-500  text-white font-bold py-2 px-4 rounded">View</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
