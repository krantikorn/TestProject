        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('users') }}">
                        <img src="{{ asset('images/logo.png') }}" onerror="this.src='images/image_placeholder.jpg'" class="block h-9 w-auto" width="50"/>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('instructors') }}" :active="request()->routeIs('instructors')">
                        {{ __('Instructors') }}
                    </x-jet-nav-link>
